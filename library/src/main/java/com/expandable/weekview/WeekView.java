...
import static com.expandable.weekview.WeekViewUtil.today;
...
public class WeekView extends View {
    ...
    public ArrayList<EventStringObject> order = new ArrayList<>();
    ...
    public WeekView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.expandable.weekview.R.styleable.WeekView, 0, 0);
        try {
            mFirstDayOfWeek = a.getInteger(com.expandable.weekview.R.styleable.WeekView_firstDayOfWeek, mFirstDayOfWeek);
            mHourHeight = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_hourHeight, mHourHeight);
            mMinHourHeight = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_minHourHeight, mMinHourHeight);
            mEffectiveMinHourHeight = mMinHourHeight;
            mMaxHourHeight = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_maxHourHeight, mMaxHourHeight);
            mTextSize = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_textSize, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mTextSize, context.getResources().getDisplayMetrics()));
            mHeaderColumnPadding = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_headerColumnPadding, mHeaderColumnPadding);
            mColumnGap = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_columnGap, mColumnGap);
            mHeaderColumnTextColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_headerColumnTextColor, mHeaderColumnTextColor);
            mNumberOfVisibleDays = a.getInteger(com.expandable.weekview.R.styleable.WeekView_noOfVisibleDays, mNumberOfVisibleDays);
            mShowFirstDayOfWeekFirst = a.getBoolean(com.expandable.weekview.R.styleable.WeekView_showFirstDayOfWeekFirst, mShowFirstDayOfWeekFirst);
            mHeaderRowPadding = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_headerRowPadding, mHeaderRowPadding);
            mHeaderRowBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_headerRowBackgroundColor, mHeaderRowBackgroundColor);
            mDayBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_dayBackgroundColor, mDayBackgroundColor);
            mFutureBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_futureBackgroundColor, mFutureBackgroundColor);
            mPastBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_pastBackgroundColor, mPastBackgroundColor);
            mFutureWeekendBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_futureWeekendBackgroundColor, mFutureBackgroundColor); // If not set, use the same color as in the week
            mPastWeekendBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_pastWeekendBackgroundColor, mPastBackgroundColor);
            mNowLineColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_nowLineColor, mNowLineColor);
            mNowLineThickness = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_nowLineThickness, mNowLineThickness);
            mHourSeparatorColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_hourSeparatorColor, mHourSeparatorColor);
            mTodayBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_todayBackgroundColor, mTodayBackgroundColor);
            mHourSeparatorHeight = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_hourSeparatorHeight, mHourSeparatorHeight);
            mTodayHeaderTextColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_todayHeaderTextColor, mTodayHeaderTextColor);
            mEventTextSize = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_eventTextSize, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mEventTextSize, context.getResources().getDisplayMetrics()));
            mEventTextColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_eventTextColor, mEventTextColor);
            mEventPadding = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_eventPadding, mEventPadding);
            mHeaderColumnBackgroundColor = a.getColor(com.expandable.weekview.R.styleable.WeekView_headerColumnBackground, mHeaderColumnBackgroundColor);
            mDayNameLength = a.getInteger(com.expandable.weekview.R.styleable.WeekView_dayNameLength, mDayNameLength);
            mOverlappingEventGap = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_overlappingEventGap, mOverlappingEventGap);
            mEventMarginVertical = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_eventMarginVertical, mEventMarginVertical);
            mXScrollingSpeed = a.getFloat(com.expandable.weekview.R.styleable.WeekView_xScrollingSpeed, mXScrollingSpeed);
            mEventCornerRadius = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_eventCornerRadius, mEventCornerRadius);
            mShowDistinctPastFutureColor = a.getBoolean(com.expandable.weekview.R.styleable.WeekView_showDistinctPastFutureColor, mShowDistinctPastFutureColor);
            mShowDistinctWeekendColor = a.getBoolean(com.expandable.weekview.R.styleable.WeekView_showDistinctWeekendColor, mShowDistinctWeekendColor);
            mShowNowLine = a.getBoolean(com.expandable.weekview.R.styleable.WeekView_showNowLine, mShowNowLine);
            mHorizontalFlingEnabled = a.getBoolean(com.expandable.weekview.R.styleable.WeekView_horizontalFlingEnabled, mHorizontalFlingEnabled);
            mVerticalFlingEnabled = a.getBoolean(com.expandable.weekview.R.styleable.WeekView_verticalFlingEnabled, mVerticalFlingEnabled);
            mAllDayEventHeight = a.getDimensionPixelSize(com.expandable.weekview.R.styleable.WeekView_allDayEventHeight, mAllDayEventHeight);
            mScrollDuration = a.getInt(com.expandable.weekview.R.styleable.WeekView_scrollDuration, mScrollDuration);
    ...
    /**
     * Initialize time column width. Calculate value with all possible hours (supposed widest
     * text).
     */
     ...
     * @param canvas       The canvas to draw upon.
     * @param originalTop  The original top position of the rectangle. The rectangle may have some
     ...
     * than one rectangle for a single event (an event that expands more than one day). In that case
     * two instances of the EventRect will be used for a single event. The given event will be
     * stored in "originalEvent". But the event that corresponds to rectangle the rectangle instance
     * will be stored in "event".
     */
    ...
    public void setOrder(ArrayList<EventStringObject> orderList) {
        order = orderList;
    }
     ...
     * <p>
     * <b>Note:</b> This method will only work if the week view is set to display more than 6 days
     * at once.
     * </p>
     *
     * @param firstDayOfWeek The supported values are {@link Calendar#SUNDAY}, {@link
    ...
    /**
     * Set the length of the day name displayed in the header row. Example of short day names is 'M'
     * for 'Monday' and example of long day names is 'Mon' for 'Monday'.
     * <p>
     * <b>Note:</b> Use {@link #setDateTimeInterpreter(DateTimeInterpreter)} instead.
     * </p>
     *
     * @param length Supported values are {@link com.expandable.weekview.WeekView#LENGTH_SHORT} and
     *               {@link com.expandable.weekview.WeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    /**
     * Whether past and future days should have two different background colors. The past and future
     * day colors are defined by the attributes `futureBackgroundColor` and `pastBackgroundColor`.
     *
    ...
    public interface EventLongPressListener {
        ...
        /**
         * Similar to {@link com.expandable.weekview.WeekView.EventClickListener} but with a long
         * press.
         *
         * @param event:     event clicked.
         * @param eventRect: view containing the clicked event.
    ...
    public interface EmptyViewClickListener {
         ...
         *
         * @param time: {@link Calendar} object set with the date and time of the clicked position
         *              on the view.
         */
    ...
    public interface EmptyViewLongPressListener {
        ...
        /**
         * Similar to {@link com.expandable.weekview.WeekView.EmptyViewClickListener} but with long
         * press.
         *
         * @param time: {@link Calendar} object set with the date and time of the long pressed
